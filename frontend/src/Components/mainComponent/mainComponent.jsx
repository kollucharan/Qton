      ...
      <div className="benefits">
        ...
        <div className="benefits__content">
          ...
          <ul className="benefits__list">
            <li>Instantly generate quizzes for any topic or subject</li>
            <li>Customize difficulty levels and question types with ease</li>
            <li>Pair with AI proctoring tools for end-to-end automation of test creation</li>
            <li>Generate questions in real-time to test specific candidate skills during any remote interviews</li>
          </ul>
